...
Run one of these commands:
  ...
  + =obsidian-tools-file-to-front-matter-title= : Change the title in the YAML front matter of the current buffer to be identical to the filename of the buffer.
